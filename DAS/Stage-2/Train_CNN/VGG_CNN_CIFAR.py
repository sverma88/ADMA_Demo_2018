...
class VGG(object):
    ...
    def train(self, config):
        ...
        for iter in range(len(iter_labels)):
            ...
            scipy.io.savemat('./results/Accuracy_{}_{}_{}.mat'.format(alpha, fixed_label, iter_labels[iter]),
                             mdict={'Accuracy': Accuracy})
            scipy.io.savemat('./results/Pred_Labels_{}_{}_{}.mat'.format(alpha, fixed_label, iter_labels[iter]),
    ...
    def load_train(self, split_prec, fixed_digit, iter_digit, fold):
        ...
        AugX = mat['Unbiased_Batch_Images']
        AugX = AugX[0, fold]
        ...
        AugY = mat['Unbiased_Batch_Labels']
        AugY = AugY[0, fold]
